...
export declare namespace _Sketch {
    ...
    class SketchDom {
        ...
        GroupBehavior: typeof GroupBehavior;
        /** A Sketch hotspot. */
        ...
        export(
            ...
            options?: {
                ...
                compression?: number,
                /** Specify the destination filename directly */
                filename?: string,
            }
    ...
    class Layer extends Component {
        ...
        /** The horizontal sizing behavior of the layer */
        horizontalSizing: FlexSizing;
        /** The vertical sizing behavior of the layer */
        verticalSizing: FlexSizing;
        /** The horizontal pinning configuration of the layer */
        horizontalPins: Pin;
        /** The vertical pinning configuration of the layer */
        verticalPins: Pin;
    }
    /** A group of layers. It is also an instance of Layer so all the methods defined there are available. */
    class Group extends Layer {
         ...
         */
        adjustToFit(): Group;
        /** The behavior type of this group container */
    ...
    interface Shadow {
        ...
        /** Whether the fill is active or not. */
        enabled: boolean,
        /**  distinguish an inner shadow from a drop shadow **/
